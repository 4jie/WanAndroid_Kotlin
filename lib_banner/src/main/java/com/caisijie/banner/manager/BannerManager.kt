package com.caisijie.banner.manager
...
import com.caisijie.banner.controller.AttributeController
import com.caisijie.banner.options.BannerOptions
import com.caisijie.banner.transform.OverlapPageTransformer
...
class BannerManager {
    ...
    fun setMultiPageStyle(overlap: Boolean, scale: Float) {
        ...
        mDefaultPageTransformer = if (overlap) {
            OverlapPageTransformer(
                mBannerOptions.getOrientation() ?: ViewPager2.ORIENTATION_HORIZONTAL,
                scale,
                0f,
                1f,
                0f

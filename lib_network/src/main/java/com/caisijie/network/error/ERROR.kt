 ...
 * @author caisijie
 * @date 2023/9/10
 * @description 定义一个枚举类，枚举所有可能遇到的HTTP状态码及提示消息
 */
enum class ERROR(val code: Int, val errMsg: String) {
    ...
    //无法找到指定位置的资源
    NOT_FOUND(404, "找不到指定位置的资源"),

    //在服务器许可的等待时间内，客户一致没有发出任何请求
    REQUEST_TIMEOUT(408, "请求超时"),

    //服务器遇到了意料不到的情况，不能完成客户的请求
    INTERNAL_SERVER_ERROR(500, "服务器错误"),

    //服务器作为网关或代理时，为了完成请求访问下一个服务器，但该服务器返回了非法的应答
    BAD_GATEWAY(502, "非法应答"),

    //服务器由于维护或者负载过重未能应答
    SERVICE_UNAVAILABLE(503, "服务器未能应答"),

    //由作为网关或代理的服务器使用，表示不能及时从远程服务器获得应答
